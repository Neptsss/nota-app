    ...
    <div class="p-3 flex flex-col flex-1">
        ...
        <ul class="flex flex-col gap-2">
            ...
            <li>
                <a href="{{ route('nasabah.index') }}"
                    class="relative flex items-center h-12 px-3 rounded-xl transition-all duration-200 hover:bg-white hover:text-primary {{ request()->routeIs('nasabah.*') ? 'bg-white text-primary' : 'text-gray-300' }}">
                    <div class="w-8 flex justify-center items-center">
        ...
        <div class="mt-auto">
            <form action="{{route('logout')}}" method="post">
                @csrf
                <button type="submit"
                    class="relative flex items-center h-12 px-3 rounded-md  hover:bg-white text-gray-300 hover:text-primary transition-all duration-200 gap-5 w-full cursor-pointer">
                    <div class="w-8 flex justify-center items-center">
